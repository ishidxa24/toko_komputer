<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Barang Keluar</h2>
    </x-slot>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-2xl">
            <h3 class="text-lg font-bold text-gray-800 mb-4">Catat Barang Keluar</h3>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100"><h3 class="text-lg font-bold text-gray-800">Riwayat Barang Keluar</h3></div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($transaksi as $t)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-red-600 font-semibold">-{{ $t->jumlah }}</td>
                        </tr>
                    @empty
                        <tr><td colspan="4" class="px-6 py-8 text-center text-gray-400">Belum ada barang keluar.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
